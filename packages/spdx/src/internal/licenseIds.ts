// Vendored SPDX license identifier lists. The two arrays below are
// machine-generated by `lib/scripts/generate-data.ts` from the `spdx-license-ids`
// package (https://github.com/jslicense/spdx-license-ids), CC0-1.0. That
// package republishes the SPDX License List (https://spdx.org/licenses/),
// maintained by the Linux Foundation's SPDX workgroup. Do not edit the
...
/** @internal */
export const LICENSE_IDS: ReadonlySet<string> = new Set(ACTIVE_LICENSE_IDS);

/** @internal */
export const DEPRECATED_LICENSE_IDS: ReadonlySet<string> = new Set(DEPRECATED_LICENSE_ID_LIST);
