...
- There is still no way to opt out of the pins through the `Git` service itself — #655's decision stands. [#671][#671]
...
[#671]: https://github.com/spencerbeggs/effected/pull/671
