...
- Refreshed the bundled Node.js, Bun and Deno version defaults from the upstream release feeds [#809][#809]

### Thanks

Thanks to [@spencerbeggs](https://github.com/apps/spencerbeggs) for their contributions!

[#809]: https://github.com/spencerbeggs/effected/pull/809
...
- Refreshed the bundled Node.js, Bun and Deno version defaults from the upstream release feeds [#759][#759]

### Thanks

Thanks to [@spencerbeggs](https://github.com/apps/spencerbeggs) for their contributions!

[#759]: https://github.com/spencerbeggs/effected/pull/759
...
- Refreshed the bundled Node.js, Bun and Deno version defaults from the upstream release feeds [#674][#674]

### Thanks

Thanks to [@spencerbeggs](https://github.com/apps/spencerbeggs) for their contributions!

[#674]: https://github.com/spencerbeggs/effected/pull/674

## 0.5.1

### Maintenance

- Refreshed the bundled Node.js, Bun and Deno version defaults from the upstream release feeds [#665][#665]

### Thanks

Thanks to [@spencerbeggs](https://github.com/apps/spencerbeggs) for their contributions!

[#665]: https://github.com/spencerbeggs/effected/pull/665
