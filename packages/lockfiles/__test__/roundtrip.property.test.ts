...
const resolvedPackageArb: FastCheck.Arbitrary<ResolvedPackage> = FastCheck.record({
	...
	peerDependencies: FastCheck.dictionary(
		FastCheck.constantFrom("react", "b"),
		FastCheck.constantFrom("^18.0.0", "2.x"),
	),
	peerDependenciesMeta: FastCheck.dictionary(
		FastCheck.constantFrom("react", "b"),
		FastCheck.record({ optional: FastCheck.boolean() }),
	),
	resolved: FastCheck.dictionary(FastCheck.constantFrom("a", "b"), FastCheck.constantFrom("a@1.0.0", "b@2.0.0")),
	unresolvedEdges: FastCheck.array(FastCheck.constantFrom("c", "d"), { maxLength: 2 }),
}).map((r) =>
