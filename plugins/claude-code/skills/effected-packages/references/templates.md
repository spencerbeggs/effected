...
- **Ambiguity fails typed, never silently.** Unterminated, orphaned, overlapping and duplicate sections are all `SectionParseError`. v3 skipped unterminated markers, which made the next write append a *second* copy of the section.
