...
| `CommitLogEntry` | Class | One commit of a `git log` listing, with the paths that commit touched. | one commit from git log with sha, author identity, both dates as DateTime.Utc, and touched paths |
