...
description: >-
  Use when generating a CycloneDX SBOM, checking NTIA minimum elements, building an in-toto
  statement or a SLSA provenance predicate, signing into a Sigstore DSSE bundle, or uploading an
  attestation to GitHub.
---
