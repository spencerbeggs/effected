...
description: >-
  Use when reporting what a GitHub Action or GitHub API caller did — workflow-command logs, a job
  summary, a GitHub check run, a sticky pull-request comment, or a living markdown document of
  check state.
---
