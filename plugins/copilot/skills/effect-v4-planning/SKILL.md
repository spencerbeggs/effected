...
description: >-
  Use when about to design, build, add, extend, or modify a feature, module, service, or schema in
  Effect v4 — before writing implementation code. Triggers on "design/add/build a feature", "new
  service/schema/module", "change/refactor existing Effect code", and any moment you are reaching
  for Effect code without an explicit design first.
---
