...
Also ships `Git.lsTree`, `Git.mergeBase`, `Git.revParse` and `Git.checkout`, plus `GitCommand.*` — the seven invocations as pure, inspectable `Command` values you can test against without spawning anything.
