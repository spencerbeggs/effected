...
4. **Test** with `@effect/vitest` (v4 beta; reference implementation: [effect-smol packages/vitest](https://github.com/Effect-TS/effect-smol/tree/main/packages/vitest)) using the `__test__/` conventions in `__test__/CLAUDE.md`.
